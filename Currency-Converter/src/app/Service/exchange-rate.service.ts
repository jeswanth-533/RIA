...
export class ExchangeRateService {
  ...
  ratesBetweendates:string = 'https://api.exchangeratesapi.io/history?start_at=2018-01-01&end_at=2018-01-01';
  rateByTimePeriodAndSymbol:string = 'https://api.exchangeratesapi.io/history?';
  ...
  public getExchangeRatebyTimePeriod(startDate:Date,endDate:Date,symbol:string):Observable<any>{
    var finalUrl = this.rateByTimePeriodAndSymbol + 'start_at='+ startDate +'&' + 'end_at=' + endDate + '&symbols='+symbol;
